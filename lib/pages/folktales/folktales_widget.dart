...
import 'folktales_model.dart';
export 'folktales_model.dart';

class FolktalesWidget extends StatefulWidget {
  const FolktalesWidget({super.key});

  @override
  State<FolktalesWidget> createState() => _FolktalesWidgetState();
}

class _FolktalesWidgetState extends State<FolktalesWidget> {
  late FolktalesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FolktalesModel());
                                          ...
                                          child: Container(
                                            ...
                                            child: wrapWithModel(
                                              ...
                                              child: BaranggayCardWidget(
                                                key: Key(
                                                  'Keyhy5_${wrapBarangayRecord.reference.id}',
                                                ),
                                                brgImage:
